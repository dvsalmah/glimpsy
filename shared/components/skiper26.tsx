...
@keyframes scale {
  ...
  if (variant === "circle-blur") {
    if (start === "center") {
      return {
        ...
        ::view-transition-new(root) {
          animation-name: reveal-light-center-blur;
          animation-duration: 1s;
          animation-timing-function: var(--expo-out);
        ...
        .dark::view-transition-old(root) {
          animation-name: hide-light-center-blur;
          animation-duration: 1s;
          animation-timing-function: var(--expo-out);
          animation-fill-mode: both;
          z-index: 1;
        ...
        @keyframes reveal-light-center-blur {
          from {
            clip-path: circle(0% at center);
          }
          to {
            clip-path: circle(150.0% at center);
          }
        }
        @keyframes hide-light-center-blur {
          from {
            clip-path: circle(150.0% at center);
          }
          to {
    ...
    return {
      ...
      ::view-transition-new(root) {
        animation-name: reveal-light-${start}-blur;
        animation-duration: 1s;
        animation-timing-function: var(--expo-out);
        animation-fill-mode: both;
        z-index: 1;
      ...
      .dark::view-transition-old(root) {
        animation-name: hide-light-${start}-blur;
        animation-duration: 1s;
        animation-timing-function: var(--expo-out);
        animation-fill-mode: both;
        z-index: 1;
      ...
      @keyframes reveal-light-${start}-blur {
        from {
          clip-path: circle(0% at ${transformOrigin.replace("-", " ")});
        }
        to {
          clip-path: circle(150.0% at ${transformOrigin.replace("-", " ")});
        }
      }
      @keyframes hide-light-${start}-blur {
        from {
          clip-path: circle(150.0% at ${transformOrigin.replace("-", " ")});
        }
        to {
  ...
  if (variant === "circle" && start !== "center") {
    ...
    return {
      ...
      .dark::view-transition-old(root) {
        animation-name: hide-light-${start}${blur ? "-blur" : ""};
        animation-duration: 1s;
        animation-timing-function: var(--expo-out);
        animation-fill-mode: both;
        z-index: 1;
      ...
      @keyframes hide-light-${start}${blur ? "-blur" : ""} {
        from {
          clip-path: circle(150.0% at ${clipPosition});
          ${blur ? "filter: blur(0px);" : ""}
        }
